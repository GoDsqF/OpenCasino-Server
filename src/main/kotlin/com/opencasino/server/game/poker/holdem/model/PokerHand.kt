...
class PokerHand private constructor(
    val cards: List<Card>,
    ...
    companion object {
        ...
        fun fromList(cards: List<Card>): PokerHand = PokerHand(cards.sortedBy { it.rank.ordinal })
        ...
        when {
            (this.isStraightFlush || other.isStraightFlush) ->
                if (this.isStraightFlush) {
                    if (!other.isStraightFlush) {
                        WIN
                    } else {
                        compareByHighCard(other)
                    }
                } else {
                    LOSS
                }
