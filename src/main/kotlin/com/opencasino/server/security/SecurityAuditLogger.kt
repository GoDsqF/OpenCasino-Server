...
class SecurityAuditLogger {
    ...
    fun logout(ip: String?) = emit("auth.logout", mapOf("ip" to ip))
    ...
    private fun format(value: Any): String {
        ...
        return if (s.any { it.isWhitespace() || it == '"' }) {
            "\"" + s.replace("\"", "\\\"") + "\""
        } else {
            s
        }
